...
const AddressForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formattedAddress = `${addressData.address1}, ${addressData.address2 ? addressData.address2 + ', ' : ''}${addressData.city}, ${addressData.country}, ${addressData.zipCode} (${addressData.addressType})`;
